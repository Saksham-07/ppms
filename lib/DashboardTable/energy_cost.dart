...
Future<List<EnergyDetail>> fetchEnergyCost(String from, String to, String units,String vgUnit) async {
  final response = await http.get(
    Uri.parse('${TBaseURL.baseUrl}mngmnt_review_vg?type=EnergyCost&unitVg=$vgUnit&fromDate=$from&toDate=$to&unit=$units&proc_type=MngmntReviewEnergyCost'),
  );
...
class _EnergyDataTableState extends State<EnergyDataTable> {
  ...
  void initState() {
    super.initState();
    energyData = fetchEnergyCost(widget.from, widget.to, widget.units, widget.vgUnit);
  }
