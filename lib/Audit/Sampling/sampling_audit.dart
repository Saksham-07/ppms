...
class SamplingAuditPage extends StatefulWidget {
  final Map<String, dynamic> tableData;
  final Map<String, dynamic> textFieldData;
  final Map<String, dynamic> allData;

  const SamplingAuditPage({super.key, required this.tableData, required this.textFieldData, required this.allData});

  @override
  SamplingAuditPageState createState() => SamplingAuditPageState();
}

class SamplingAuditPageState extends State<SamplingAuditPage> {
  ...
  Future<void> getVariable()async {
    int? sampleS = int.tryParse(receivedQty.text);
  ...
  Future<void> _fetchQtysOptions() async {
    String url = '${TBaseURL.auditUrl}sewing_audit?type=Qty&unit=${widget.allData['Unit']}&style=${widget.allData['Style']}&color=${widget.allData['Color']}&line_Id=${widget.allData['LineId']}&lineId=${widget.allData['Line']}&orderNo=${widget.allData['Order']}';
  ...
  Future<List<dynamic>> fetchDataMap() async {
    ...
    String? jsonData = prefs.getString('SampleData');
  ...
  Future<void> saveCatchData(List<dynamic> data) async {
    ...
    await prefs.setString('SampleData', json.encode(data));
  ...
  Future<void> _fetchDocId() async {
    String url = '${TBaseURL.auditUrl}sewing_audit?type=Doc&unit=&style=${widget.allData['Style']}&color=${widget.allData['Color']}&lineId=${widget.allData['LineId']}&line_Id=&orderNo=${widget.allData['Order']}&AuditNo=';
    final response = await http.get(Uri.parse(url));
  ...
  Future<void> sendTransformedData(List<dynamic> data) async {
    ...
    String apiUrl = "${TBaseURL.auditLocalUrl}insert_sampling";
